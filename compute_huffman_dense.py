#!/usr/bin/env python3
"""
compute_huffman_dense.py
========================
Dense gradient distribution — FREQS[0x00] = 100.
Models late-training or fully-dense gradients where no byte dominates.

Run from the project root:
    python compute_huffman_dense.py
"""
...
FREQS[0x00] = 100           # zero byte — only slightly more common
FREQS[0x80] = 80            # negative-zero in IEEE float
FREQS[0x3F] = 60            # small +ve bfloat16 (exponent ~0x3F)
FREQS[0x40] = 50            # slightly larger +ve
FREQS[0xBF] = 50            # small -ve bfloat16
FREQS[0xC0] = 40            # slightly larger -ve
...
print("=" * 60)
print("Canonical Huffman — Dense gradient distribution")
print("=" * 60)
...
a("// Auto-generated by compute_huffman_dense.py — DO NOT EDIT MANUALLY")
a("//")
a(f"// Distribution : dense gradient (FREQS[0x00]=100)")
