...
REM
REM Generated by Vivado on Wed Feb 04 15:25:31 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj huffman_encoder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj huffman_encoder_vlog.prj -log xvlog.log
