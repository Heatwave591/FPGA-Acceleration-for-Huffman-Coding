...
REM
REM Generated by Vivado on Sun Feb 08 17:09:19 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj huffman_encoder_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj huffman_encoder_tb_vlog.prj -log xvlog.log
